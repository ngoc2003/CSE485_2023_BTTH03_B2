...
<a class="btn btn-primary" href="index.php?controller=quizz&action=index">Quizz</a>
<a class="btn btn-primary" href="index.php?controller=option&action=index">Option</a>